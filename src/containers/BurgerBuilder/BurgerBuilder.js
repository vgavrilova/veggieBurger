...
const mapDispatchToProps = (dispatched) => {
    return {
        onAddIngredientHandler: (ingName) => dispatched(actions.addIngredientAction(ingName)),
        onRemoveIngredientHandler: (ingName) => dispatched(actions.removeIngredientAction(ingName)),
